...
export default function StageHeader() {
	...
	return (
		<div className='stage-header__container'>
				...
				<div className='stage-header__center'>
					{tabs.map((tab) => (
						<a
							...
							data-current={globalThis.location.href.includes(
								`/projects/${project_id.value}/${stage_id.value}/${tab.href}`,
							)}
							href={`/projects/${project_id.value}/${stage_id.value}/${tab.href}`}
							f-partial={`/projects/${project_id.value}/${stage_id.value}/${tab.href}`}
						>
							{tab.label}
						</a>
					))}
