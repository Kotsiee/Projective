...
const SERVICES: Seed[] = [
	{
		id: 'svc-1',
		entity_type: 'service',
		title: 'Full-stack SaaS MVP in 4 weeks',
		description:
			'End-to-end product build: auth, billing, dashboards, and a polished design system.',
		owner_name: 'Aria Okonkwo',
		owner_handle: 'ariabuilds',
	...
	},
	{
		id: 'svc-2',
		entity_type: 'service',
		title: 'Conversion-focused brand identity',
		description: 'Logo, type system, and a full brand kit tuned for high-growth startups.',
		owner_name: 'Milo Fenwick',
		owner_handle: 'milodesigns',
	...
	},
	{
		...
		description: '12-slide narrative deck with financial models and a story that closes rounds.',
		owner_name: 'Priya Nair',
		owner_handle: 'priyadecks',
		tags: ['Pitch', 'Slides', 'Finance'],
		banner: 'amber',
		accent: 'amber',
		rating: 4.7,
		reviews: 96,
	...
	},
	{
		id: 'svc-4',
		entity_type: 'service',
		title: 'Technical SEO & growth audit',
		description: 'Full crawl, Core Web Vitals fixes, and a 90-day compounding growth roadmap.',
		owner_name: 'Devon Reyes',
		owner_handle: 'devongrowth',
	...
	},
	{
		id: 'svc-5',
		entity_type: 'service',
		title: 'Cinematic product launch video',
		description: '60-second hero film — script, 3D motion, sound design, and social cutdowns.',
		owner_name: 'Selene Vaughn',
		owner_handle: 'selenemotion',
	...
	},
	{
		...
		description: 'Custom LLM workflows wired into your stack — retrieval, tools, and guardrails.',
		owner_name: 'Kenji Watari',
		owner_handle: 'kenjiml',
...
const PRODUCTS: Seed[] = [
	{
		id: 'prd-1',
		entity_type: 'product',
		title: 'Nebula UI — Design System Kit',
		description: '480+ Figma components with a matching React library.',
		owner_name: 'Studio Aurora',
		owner_handle: 'studioaurora',
		tags: ['UI Kit', 'Figma'],
		banner: 'violet',
		accent: 'violet',
		rating: 4.9,
	...
	},
	{
		id: 'prd-2',
		entity_type: 'product',
		title: 'SaaS Starter — Fresh + Supabase',
		description: 'Production boilerplate with auth, billing, and RBAC.',
		owner_name: 'Aria Okonkwo',
		owner_handle: 'ariabuilds',
		tags: ['Boilerplate', 'Deno'],
		banner: 'mint',
		accent: 'mint',
		rating: 4.8,
		reviews: 642,
	...
	},
	{
		id: 'prd-3',
		entity_type: 'product',
		title: 'Lumen Icon Pack (2,400 icons)',
		description: 'Pixel-perfect stroke icons in SVG + font formats.',
		owner_name: 'Milo Fenwick',
		owner_handle: 'milodesigns',
		tags: ['Icons', 'SVG'],
		banner: 'amber',
	...
	},
	{
		...
		description: '220-page field guide with 150 production prompt patterns.',
		owner_name: 'Kenji Watari',
		owner_handle: 'kenjiml',
		tags: ['AI', 'Ebook'],
		banner: 'forest',
	...
	},
	{
		id: 'prd-5',
		entity_type: 'product',
		title: 'Motion Presets — Vol. 3',
		description: '120 drag-and-drop After Effects transitions.',
		owner_name: 'Selene Vaughn',
		owner_handle: 'selenemotion',
		tags: ['Motion', 'AE'],
		banner: 'ember',
	...
	},
	{
		...
		description: 'Realtime charts, cohorts, and funnels — plug in your data.',
		owner_name: 'Devon Reyes',
		owner_handle: 'devongrowth',
	...
	},
	{
		id: 'prd-7',
		entity_type: 'product',
		title: 'Type Foundry — Grotesk Family',
		description: '9 weights with variable font + web licenses.',
		owner_name: 'Studio Aurora',
		owner_handle: 'studioaurora',
		tags: ['Fonts', 'Type'],
		banner: 'slate',
	...
	},
	{
		...
		description: 'A complete second-brain workspace for early teams.',
		owner_name: 'Priya Nair',
		owner_handle: 'priyadecks',
...
const PROFILES: Seed[] = [
	{
		...
		entity_type: 'person',
		title: 'Aria Okonkwo',
		description: 'Senior full-stack engineer — ships production SaaS end-to-end.',
		owner_name: 'Aria Okonkwo',
		owner_handle: 'ariabuilds',
		tags: ['React', 'Deno', 'Postgres'],
		banner: 'mint',
		accent: 'mint',
		rating: 4.9,
		reviews: 214,
	...
	},
	{
		...
		description: 'Product design squad for venture-backed startups.',
		owner_name: 'Northwind Collective',
		owner_handle: 'northwind',
		tags: ['Design', 'Product', 'Brand'],
		banner: 'violet',
		accent: 'violet',
		rating: 4.8,
		reviews: 156,
	...
	},
	{
		...
		title: 'Helios Studios',
		description: 'Full-service motion & video production house.',
		owner_name: 'Helios Studios',
		owner_handle: 'heliostudios',
		tags: ['Video', 'Motion', '3D'],
		banner: 'ember',
		accent: 'ember',
		rating: 4.9,
		reviews: 302,
	...
	},
	{
		...
		entity_type: 'person',
		title: 'Priya Nair',
		description: 'Pitch & narrative designer — helped raise $40M+ collectively.',
		owner_name: 'Priya Nair',
		owner_handle: 'priyadecks',
	...
	},
	{
		...
		entity_type: 'person',
		title: 'Kenji Watari',
		description: 'ML engineer specializing in LLM agents & retrieval systems.',
		owner_name: 'Kenji Watari',
		owner_handle: 'kenjiml',
		tags: ['AI', 'Python', 'RAG'],
		banner: 'forest',
	...
	},
	{
		...
		entity_type: 'team',
		title: 'Studio Aurora',
		description: 'Design-systems studio crafting UI kits & type.',
		owner_name: 'Studio Aurora',
		owner_handle: 'studioaurora',
		tags: ['UI', 'Systems', 'Type'],
		banner: 'slate',
		accent: 'neutral',
		rating: 4.9,
		reviews: 1203,
...
const PROJECTS: Seed[] = [
	{
		id: 'prj-1',
		entity_type: 'project',
		title: 'Fintech mobile app — end-to-end build',
		description:
			'Seeking a cross-functional squad to design and ship a regulated consumer fintech app across iOS & Android.',
		owner_name: 'Meridian Bank',
		owner_handle: 'meridian',
		tags: ['React Native', 'Fintech', 'Design', 'Security'],
		banner: 'ocean',
		accent: 'ocean',
		rating: 4.7,
		reviews: 12,
		...
		scope: {
			...
			stage_count: 6,
			duration_weeks: 20,
			budget_min_cents: cents(80000),
			budget_max_cents: cents(120000),
			format: 'pipeline',
		},
	},
	{
		id: 'prj-2',
		entity_type: 'project',
		title: 'Rebrand + design system for D2C brand',
		description:
			'Complete visual rebrand, packaging, and a scalable design system rollout across web and retail.',
		owner_name: 'Bloom & Co',
		owner_handle: 'bloomco',
		tags: ['Branding', 'Packaging', 'Design System'],
		banner: 'violet',
		accent: 'violet',
		rating: 4.6,
		reviews: 8,
		...
		scope: {
			...
			stage_count: 4,
			duration_weeks: 12,
			budget_min_cents: cents(35000),
			budget_max_cents: cents(55000),
			format: 'one_off',
		},
	},
	{
		...
		description:
			'Build a retrieval-augmented support agent integrated with Zendesk and an internal knowledge base.',
		owner_name: 'Vertex SaaS',
		owner_handle: 'vertex',
		tags: ['AI', 'LLM', 'Integrations'],
		banner: 'mint',
		accent: 'mint',
		rating: 4.8,
		reviews: 5,
		...
		scope: {
			...
			stage_count: 5,
			duration_weeks: 10,
			budget_min_cents: cents(40000),
			budget_max_cents: cents(70000),
			format: 'pipeline',
		},
	},
	{
		id: 'prj-4',
		entity_type: 'project',
		title: 'Launch film + paid social campaign',
		description:
			'Hero launch video plus a 6-week paid social sprint with weekly creative iterations.',
		owner_name: 'Helios Studios',
		owner_handle: 'heliostudios',
		tags: ['Video', 'Paid Social', 'Motion'],
		banner: 'ember',
		accent: 'ember',
		rating: 4.9,
		reviews: 9,
		...
		scope: {
			...
			stage_count: 3,
			duration_weeks: 8,
			budget_min_cents: cents(25000),
			budget_max_cents: cents(45000),
			format: 'session',
		},
	},
];
...
export function recommended(): ExploreEntity[] {
	return [...ALL]
		...
		.sort((a, b) =>
			(a.featured_rank ?? 99) - (b.featured_rank ?? 99) || b.rating_average - a.rating_average
		)
		.slice(0, 8);
}
...
function matchesQuery(e: ExploreEntity, q: string): boolean {
	if (!q) return true;
	const hay = `${e.display_title} ${e.display_description ?? ''} ${e.owner_name} ${
		e.tags.join(' ')
	}`
		.toLowerCase();
